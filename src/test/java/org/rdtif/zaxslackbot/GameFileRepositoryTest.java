...
class GameFileRepositoryTest {
    ...
    void fileNamesNeverReturnsNull() {
        GameFileRepository repository = new GameFileRepository(Zoey.createConfigurationInstance(GAME_DIRECTORY));

        Collection<String> gameFiles = repository.fileNames();

        assertThat(gameFiles, notNullValue());
    }
